...
security.setAdminPermissions(curJob, security.GROUP_ADMIN)
security.setBasicPermissions(curJob, security.GROUP_DEV)
security.setBasicPermissions(curJob, security.GROUP_CGI)
